...
def plot_confusion_matrix(cm, class_names, results_path, test_data):
    ...
    os.makedirs(results_path, exist_ok=True)
    out_file = f"{results_path}/Confusion_Matrix_{test_data}.png"
...
if __name__ == "__main__":
    ...
    try:
        ...
        # Load training data
        train_csv = 'Datasets/ADNI-Oasis_dataset.csv'
        ...
        try:
            ...
            print(f"Loaded test data for multiple subjects from: {test_csv}")
            ...
            test_output_filename = f"{test_results_path}/Test_Prediction_{test_data}.csv"
            ...
            check_accuracy(test_results_path, test_data)


        except FileNotFoundError:
            print(f"Error: Test file {test_csv} not found. Please ensure it is in the same directory.")
        except Exception as e:
